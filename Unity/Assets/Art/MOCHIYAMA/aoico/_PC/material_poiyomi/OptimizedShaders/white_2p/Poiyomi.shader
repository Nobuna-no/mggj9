Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi Toon/a8c9f827822920c4f95eb9d484fed89f"
{
	Properties
	{
...
#define PROP_SATURATION 0.13
#define PROP_MAINBRIGHTNESS -0.02
#define PROP_MAINHUESHIFTTOGGLE 1
#define PROP_MAINHUESHIFTREPLACE 1
#define PROP_MAINHUESHIFT 0.384
...
#define PROP_BASECOLOR_STEP 0
#define PROP_BASESHADE_FEATHER 0.01
#define PROP_SHADECOLOR_STEP 0.34
#define PROP_1ST2ND_SHADES_FEATHER 0.6
...
#define PROP_RIMLIGHT_POWER 0.115
#define PROP_RIMLIGHT_INSIDEMASK 0.193
...
#define PROP_HIGHCOLOR_POWER 0.728
...
#define PROPM_END_STENCILPASSOPTIONS 0
			...
			{
				float MainColorFeatherStep = float(0) - float(0.01);
				float firstColorFeatherStep = float(0.34) - float(0.6);
				#if defined(PROP_1ST_SHADEMAP) || !defined(OPTIMIZER_ENABLED)
				...
				firstShadeMap.rgb *= float4(0.723123,0.7086672,0.8176128,1).rgb; //* lighColor
				...
				float mainShadowMask = saturate(1 - ((poiLight.lightMap) - MainColorFeatherStep) / (float(0) - MainColorFeatherStep) * (shadowMask));
				float firstSecondShadowMask = saturate(1 - ((poiLight.lightMap) - firstColorFeatherStep) / (float(0.34) - firstColorFeatherStep) * (shadowMask));
