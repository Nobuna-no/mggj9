Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi Toon/f392b5bccd3bf9d44b9a35193af10f58"
{
	Properties
	{
...
#define PROP_ALPHADITHERGRADIENT 1
...
#define PROP_1ST2ND_SHADES_FEATHER 0.601
...
#define PROP_RIMLIGHT_POWER 0.09
#define PROP_RIMLIGHT_INSIDEMASK 0.129
...
#define PROPM_END_STENCILPASSOPTIONS 0
			...
			void applyShadeMapping(inout PoiFragData poiFragData, PoiMesh poiMesh, inout PoiLight poiLight)
			{
				...
				float firstColorFeatherStep = float(0.34) - float(0.601);
				#if defined(PROP_1ST_SHADEMAP) || !defined(OPTIMIZER_ENABLED)
